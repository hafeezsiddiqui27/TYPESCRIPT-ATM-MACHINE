...
if (pinAnswer.Pin === myPin) {
    ...
    if (operationAnswer.operation === `Withdraw Amount`) {
        ...
        if (amountAnswer.amount > myBalance) {
            ...
            console.log(chalk.bgBlueBright(`${amountAnswer.amount} Withdraw Sucessfully`), console.log(chalk.yellow(`Your Remaining Balance is${myBalance}`)));
        }
    }
...
console.log(chalk.bold.yellow(`\n  \t\t <<<================================================>>>`));
console.log(chalk.bold.greenBright(`<<<=========>>>  ${chalk.greenBright.bold(`Thanks For Using Hafeez Siddiqui - ATM Machine <<<=========>>>`)}`));
console.log(chalk.bold.yellow(`\t\t <<<===============================================>>>\n`));
